    ...
    return(
        <div className={style.regulations}>
            ...
            <ol>
                ...
                <li>Profil Gry Planszowej - podstrona w Serwisie zawierająca Dane Gry Planszowej, a także Treści i Opinie dotyczące Gry Planszowej.</li>
                ...
                <li>Prawa - autorskie prawa osobiste, autorskie prawa majątkowe, uprawnienie do zezwalania na wykonywanie praw zależnych, patenty, dodatkowe prawa ochronne na wynalazki, prawa ochronne na wzory użytkowe lub znaki towarowe lub prawa z rejestracji na wzory przemysłowe, topografie układów scalonych lub oznaczenia geograficzne, dobra osobiste bądź prawa o podobnym charakterze (odpowiednio).</li>
